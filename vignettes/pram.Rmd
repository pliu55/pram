...
```
pram::runPRAM(in_gtf, in_bamv, out_gtf)
```
...
folder.  The table provides a quick summary of all the example files.
...
You can access the example input by `system.file()` in __R__, e.g. for the 
argument `in_gtf`, you can access its example file by
```
system.file('extdata/demo/in.gtf', package='pram')
```

In addition, you can also take a look of the script 
`tests/testthat/test-runPRAM.R` on using example input.
...
| source code | Linux binary | required by  |
|:-----------:|:------------:|:------------:|
| [Cufflinks and Cuffmerge](https://github.com/cole-trapnell-lab/cufflinks)        | [v2.2.1](http://cole-trapnell-lab.github.io/cufflinks/assets/downloads/cufflinks-2.2.1.Linux_x86_64.tar.gz)  | __plcf__, __cfmg__, __cftc__, and __cf__ |
| [StringTie and StringTie-merge](https://github.com/gpertea/stringtie) | [v1.3.3b](http://ccb.jhu.edu/software/stringtie/dl/stringtie-1.3.3b.Linux_x86_64.tar.gz)  | __plst__, __stmg__, and __st__ |
| [TACO](https://github.com/tacorna/taco) | [v0.7.0](https://github.com/tacorna/taco/releases/download/v0.7.0/taco-v0.7.0.Linux_x86_64.tar.gz)  | __cftc__ |
